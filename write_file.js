...
const promiseWritePath = "/Users/zhjr/Github/node_tutorial/files/promise写入.txt";
...
//   try {
//     await fsPromises.writeFile(promiseWritePath, '这是async/await写入的txt文件');
//     const data = await fsPromises.readFile(promiseWritePath, 'utf-8')
//     console.log(data)
//   } catch (error) {
//     throw err
//   }
